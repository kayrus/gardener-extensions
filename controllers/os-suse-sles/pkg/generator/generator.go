...
// NewCloudInitGenerator creates a new Generator using the template file for suse-sles
func NewCloudInitGenerator() (*template_gen.CloudInitGenerator, error) {
	box := packr.New("templates", "./templates")
	cloudInitTemplateString, err := box.FindString("cloud-init-suse-sles.template")
	if err != nil {
		return nil, err
	}
